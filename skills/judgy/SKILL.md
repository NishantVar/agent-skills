...
|----------|---------|------------------------|
| codex | `~/.claude/skills/fork-terminal/cookbook/codex-cli.md` | `codex -c 'model_reasoning_effort="xhigh"' --dangerously-bypass-approvals-and-sandbox "$(cat /tmp/${JUDGY_SESSION}-round1.txt)"` |
| gemini | `~/.claude/skills/fork-terminal/cookbook/gemini-cli.md` | `gemini --model gemini-3-pro-preview -y -i "$(cat /tmp/${JUDGY_SESSION}-round1.txt)"` |
| claude | `~/.claude/skills/fork-terminal/cookbook/claude-code.md` | `claude --model opus --dangerously-skip-permissions "$(cat /tmp/${JUDGY_SESSION}-round1.txt)"` |
