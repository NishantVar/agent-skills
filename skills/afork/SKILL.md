...
- **permission**:
  ...
  Default: none.
- **model**: Agnostic model; falls back to the definition's declaration, else the runtime default (claude `opus`; codex/pi none). Default: none.
- **effort**:
